...
$(function() {
    ...
    function renderFields() {
        ...
        selected.forEach(function(id){
            ...
            if (restoreMap.hasOwnProperty(standard) && Array.isArray(restoreMap[standard]['fields'])) {
            ...
            $tr.append(
                '<td>' +
                (fieldsArr.length
                    ? '<ul>' + fieldsArr.map(field => '<li>' + field + '</li>').join('')
    ...
    // On submit, serialize with standard, jurisdiction, and fields array
    $('#regulationForm').on('submit', function() {
        ...
        $('.regulation-checkbox:checked').each(function() {
            ...
            var fieldsArr = raw.split(',').map(e => e.trim()).filter(Boolean);
            regs.push({
                'standard': standard,
