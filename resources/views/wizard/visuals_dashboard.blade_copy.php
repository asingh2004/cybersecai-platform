                    ...
                    <div class="col-md-9 mt-4 mt-sm-0 pl-4 pr-4">
                      ...
                      <ul class="dashboard-list">
                          <li>
                        	...
                        	<li>
                              <strong>AI Analytics Charts Dashboard:</strong>
                              <ul>
                                  <li>Interactive risk, size, time, and type analysis with AI insights—explore, filter, and drill into your data files visually</li>
                                  <li>Click any data source or metric to see a modal chart, hover for file/source, and pop up the full AI analysis for each file</li>
                              </ul>
                              <div class="d-flex flex-column align-items-center justify-content-center" style="max-width:500px;margin:3em auto 0 auto;">
                                  <a href="{{ url('/cybersecai-visuals') }}" style="text-decoration: none;width:100%;">
                                      <button class="btn btn-info btn-lg dashboard-btn mb-4">
                                          <i class="fa fa-chart-bar"></i>
                                          Analytics Visuals Dashboard
                                      </button>
                                  </a>
                              </div>
                          </li>
                          <li>
                              ...
                              <ul>
                                  <li>Visualizes users, folders, files, and AI analysis as interconnected nodes</li>
                                  <li>Explore relationships between files, folders, and sensitive data detection</li>
                              </ul>
                              <div class="d-flex flex-column align-items-center justify-content-center" style="max-width:500px;margin:3em auto 0 auto;">
                                  <a href="{{ route('wizard.file_graph_network') }}" style="text-decoration: none;width:100%;">
                                      <button class="btn btn-primary btn-lg dashboard-btn mb-4">
