                            ...
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Start Classifying</th>
                                        <th class="text-center">Show Classified Results</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            <button
                                                ...
                                                id="classify-btn-{{ $config->id }}"
                                                data-source="{{ $primarySource }}"
                                                style="min-width:120px;"
                                                onclick="startClassifying({{ $config->id }}, this)"
                                            >Start Classifying</button>
                                        </td>
                                        <td class="text-center align-middle">
                                            <button
                                                class="btn btn-sm btn-info"
                                                onclick="goToVisualsDashboard()"
                                            >Show Classified Results</button>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
