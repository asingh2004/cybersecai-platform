              ...
              @if(!empty($selected_source_name_clean))
                ...
                <table class="table table-bordered">
                  <tbody>
                    ...
                    @php
$fieldDescriptions = [
                    // Common DBs (MySQL/MariaDB/Oracle/SQLServer/Fabric)
    'host'        => 'Database server hostname or IP address.',
    'port'        => 'Database port (eg. 3306 for MySQL/MariaDB, 1433 for SQL Server/Fabric, 1521 for Oracle).',
    'user'        => 'Database username (read access is recommendation).',
    'db_password'    => 'DB user password.',
    'database'    => 'Database or schema name (may be called Service for Oracle/Fabric).',
