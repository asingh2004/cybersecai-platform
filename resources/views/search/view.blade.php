...
@section('main')
    <div class="container-fluid bg-white main-panel border-0 p-0 mt-70">
        <div class="row">
            ...
            <div class="col-md-7  hidden-pod filter-h" id="listCol">
                <div class="row mt-4">
                   <h2 class="p-2">{{trans('messages.search.results_for')}} <strong class="text-24">{{$location}} {{$respite_type}}</strong></h2>
                </div>
                        ...
                        <ul class="list-inline  pl-4">
                                ...
                                <div class="dropdown-menu card-raise dropdown-menu-room-type" aria-labelledby="dropdownRoomType">
                                    ...
                                    <div class="row p-3">
                                        ...
                                        <div class="col-md-12 p-0">
                                          ...
                                          <button class="btn vbtn-success text-16 font-weight-700  rounded" id="btnRoom">{{trans('messages.header.find_place')}}</button>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                @if($rws==1)
                                                    <div class="d-flex justify-content-between pr-4">
                                                        ...
                                                        <div>
                                                            <input type="radio" id="space_type_{{ $rws }}" name="space_type[]" value="{{ $rws }}" class="form-check-input" {{ in_array($rws, $space_type_selected)?'checked':'' }}>
                                                        </div>
                                                    </div>
                                                @endif
                            ...
                            <li class="list-inline-item  mt-4">
                                ...
                                <button class="btn text-16 border border-r-25 pl-4 pr-4 dropdown-toggle" type="button" id="dropdownRespiteType" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <h1>{{trans('messages.listing_book.respite_care_type')}}</h1>
                                </button>  -->
                                ...
                                <div class="dropdown-menu dropdown-menu-care-type" aria-labelledby="dropdownRespiteCareType">
                                    <div class="row p-3">
                                             ...
                                             @foreach($respite_service_type as $rst)
                                                <div class="col-md-6">
                                                <div class="form-check">
                                                <div class="d-flex justify-content-between pr-4">
                                                       
                                                            <div>
                                                                <p class="text-16"> {{ $rst }}</p>
                                                            </div>
                                                            <!--<option name="respite_service_type[]" class="form-check-input" value="{{ $rst }}">{{ $rst }}</option>
                                                            <option class="form-check-input" value="{{ $rst }}">{{ $rst }}</option>-->
                                                            <div>
                                                            <input type="radio" name="respite_service_type[]" class="form-check-input"  value="{{ $rst }}">
                                                        </div>
                                        ...
                                        <div class="col-md-12 text-right mt-4">
                                            <button class="btn vbtn-success text-16 font-weight-700  rounded" id="btnRespiteType">{{trans('messages.utility.submit')}}</button>
                                        </div>
                                    </div>
                                </div>
                            </li>
                                    ...
                                    <div class="row p-3">
                                        <div class="col-md-12">
                                            ...
                                            <div class="d-flex justify-content-between pr-4">
                                                ...
                                                <!-- <label class="fa fa-clock text-beach text-16" for="flexCheckChecked"> {{trans('messages.property_single.request_book')}}
                                                </label> -->
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="d-flex justify-content-between pr-4">
                                                ...
                                                <!-- <label class="fa  fa-bolt text-beach text-16" for="flexCheckChecked"> {{trans('messages.property_single.instant_book')}}
                                                </label> -->
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg " role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer p-4">
                            <button class="btn btn-outline-danger text-16 pl-3 pr-3 mr-4"  data-bs-dismiss="modal">{{ trans('messages.search.cancel') }}</button>
                            <button class="btn vbtn-outline-success filter-apply text-16 mr-5 pl-3 pr-3 ml-2" data-bs-dismiss="modal">{{ trans('messages.search.apply_filter') }}</button>
                        </div>
                    </div>
                </div>
            </div>
   ...
   <script type="text/javascript" src='https://maps.google.com/maps/api/js?key={{ @$map_key }}&callback=Function.prototype'></script> 
    ...
    +'<img src="'+properties[key].cover_photo+'" class="room-image-container200 rounded " alt="'+properties[key].name+'"/>'
                                        ...
                                        +'<a class="btn btn-sm book_mark_change" data-status="'+properties[key].book_mark +'" data-id="'+properties[key].id+'" style="color:'+ color +'">'
                                            ...
                                            +'</div>'
                                                                    +'</div>'
                                                                    +'<div>'
                                                                        +'<span class="font-weight-700 text-18">'+properties[key].respite_service_type+'</span> / {{trans('messages.property_single.night')}}'
                                                                    +'</div>'
                                                                +'</div>'
                                                            +'</div>'
