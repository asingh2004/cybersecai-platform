                                ...
                                <div class="card shadow-sm h-100">
                                    <div class="card-body">
                                        ...
                                        <div class="d-grid gap-3">
                                            ...
                                            <a href="{{ route('wizard.filesummary_treemap') }}" class="btn btn-primary btn-lg">
                                                <i class="fa fa-th-large me-2"></i> Treemap
                                            </a>
                                            <a href="{{ route('wizard.filesummary_sunburst') }}" class="btn btn-primary btn-lg">
                                                <i class="fa fa-circle-notch me-2"></i> Sunburst
                                            </a>
                                            <a href="{{ route('wizard.filesummary_stacked_bar') }}" class="btn btn-primary btn-lg">
                                                <i class="fa fa-chart-bar me-2"></i> Stacked Bar
                                            </a>
                                            <a href="{{ route('wizard.filesummary_heatmap') }}" class="btn btn-primary btn-lg">
                                                <i class="fa fa-border-all me-2"></i> Heatmap
                                            </a>
                                            <a href="{{ route('wizard.filesummary_bubble') }}" class="btn btn-primary btn-lg">
                                                <i class="fa fa-circle me-2"></i> Bubble Chart
                                            </a>
                                            <a href="{{ route('wizard.filesummary_sankey') }}" class="btn btn-primary btn-lg">
                                                <i class="fa fa-project-diagram me-2"></i> Sankey
                                            </a>
                                        </div>
                                    </div>
                                </div>
