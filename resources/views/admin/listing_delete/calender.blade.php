            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="row">
                <div class="col-md-4 col-sm-12 col-xs-12 text-left mt-30">
                  <button class="btn btn-primary imporpt_calendar text-white">Import Calendar</button>
                </div>
                <div class="col-md-4 col-sm-12 col-xs-12 mt-30">
                  <a class="js-calendar-sync btn btn-primary text-white" data-prevent-default="true" href="{{ url('admin/icalendar/synchronization/'.$result->id) }}">Sync with other calendars</a>
                </div>
                <div class="col-md-4 col-sm-12 col-xs-12 mt-30">
                  <button class="btn btn-primary text-white" id="export_icalendar">Export Calendar</button> 
                </div>
              </div>
            </div>
          </div>
