...
<div class="container mb-4 margin-top-85 min-height">
    <div class="d-flex justify-content-center">
		<div class="p-5 mt-5 mb-5 border w-450">
				...
				<form method="post" action="{{ url('reset_password/' . $token) }}" id='password-form' class='signup-form login-form' accept-charset='UTF-8'>	
                  {{ csrf_field() }}
					...
					<div class="col-sm-12 mt-4">
						<button class="OzzieAccom-button button-reactangular w-100 vbtn-success" type="submit">
