              ...
              <div class="col-md-12">
                  <nav class="navbar navbar-expand-lg navbar-light list-bacground border rounded-3 p-3">
                    ...
                    <ul class="nav nav-pills nav-fill">
                        <li class="nav-item pl-4 pr-4">
                            <a class="nav-link text-color text-color-hover" href="{{ url('users/payout-list') }}">Payouts</a>
                        </li>

                        <li class="nav-item  pl-4 pr-4">
                            <a class="nav-link text-color  secondary-text-color font-weight-700 text-color-hover" href="{{url('users/payout/request')}}">Payout Request</a>
                        </li>

                        <li class="nav-item  pl-4 pr-4">
                            <a class="nav-link text-color text-color-hover" href="{{ url('users/payout') }}">Payout Method</a>
                        </li>

                        <li class="nav-item  pl-4 pr-4">
                            <a class="nav-link text-color text-color-hover" href="{{url('users/payout/setting')}}">Payout Setting</a>
                        </li>
                    </ul>
                  </nav>
                ...
                <div class="row justify-content-between mt-4">
                  <div class="p-3">
                      <a href="{{url('users/payout-list')}}">
                        <button type="button" class="OzzieAccom-button button-reactangular vbtn-danger pl-5 pr-5">Cancel</button>
                      </a>
                  </div>

                  <div class="p-3">
                    <button type="submit" class="OzzieAccom-button button-reactangular vbtn-default pl-5 pr-5" id="submitBtn">
                        Submit
                    </button>
                  </div>
                </div>
