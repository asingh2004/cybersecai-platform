        ...
        <div class="mt-2">
            @php
                ...
                $isAiAgentsMenuActive =
                    ...
                    request()->routeIs('agentic_ai.compliance') ||
                    request()->routeIs('agenticai.docs_agent.index') ||
                    request()->is('databreach/events/create');
                ...
                <li class="list-group-item p-0 border-0 collapse {{ $isAiAgentsMenuActive ? 'show' : '' }}" id="aiAgentsMenu" style="background:none;">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item vbg-default-hover pl-25 border-0 text-15 p-4 d-flex justify-content-between align-items-center"
                            ...
                            data-bs-toggle="collapse" data-bs-target="#breachSubMenu" aria-controls="breachSubMenu" aria-expanded="{{ $isBreachSubMenuActive ? 'true' : 'false' }}">
                            <span class="text-color font-weight-500">
                                <i class="fas fa-shield-alt mr-2 text-18"></i> Breach response
                            </span>
                            <span class="collapse-arrow"><i class="fa fa-angle-down"></i></span>
                        </li>
                        <li class="list-group-item p-0 border-0 collapse {{ $isBreachSubMenuActive ? 'show' : '' }}" id="breachSubMenu" style="background:none;">
                            <ul class="list-group">
                                <li class="list-group-item vbg-default-hover pl-25 border-0 text-15 p-4 {{ request()->is('databreach/events/create') ? 'active-sidebar' : '' }}">
                                    <a href="/databreach/events/create" class="text-color font-weight-500">
                                        <i class="fas fa-bolt mr-2 text-18"></i> New incident
                                    </a>
                                </li>
                                <li class="list-group-item vbg-default-hover pl-25 border-0 text-15 p-4 {{ request()->routeIs('agentic_ai.compliance') ? 'active-sidebar' : '' }}">
                                    <a href="{{ route('agentic_ai.compliance') }}" class="text-color font-weight-500">
                                        <i class="fas fa-user-check mr-2 text-18"></i> Triage &amp; assessment
                                    </a>
                                </li>
                    ...
                    <ul class="list-group">
                        <li class="list-group-item vbg-default-hover pl-25 border-0 text-15 p-4 {{ request()->routeIs('wizard.dashboard') ? 'active-sidebar' : '' }}">
                            <a class="text-color font-weight-500" href="{{ route('wizard.dashboard') }}">
                                <i class="fa fa-database mr-2 text-18"></i> Data sources
                            </a>
                        </li>
                        <li class="list-group-item vbg-default-hover pl-25 border-0 text-15 p-4 {{ request()->routeIs('wizard.step1') ? 'active-sidebar' : '' }}">
                            <a class="text-color font-weight-500" href="{{ route('wizard.step1') }}">
                                <i class="fa fa-plus-square mr-2 text-18"></i> Add source
                            </a>
                        </li>
                    </ul>
                </li>

              	<a href="{{ route('wizard.privacyRegulations') }}" class="btn btn-info">Relevant Privacy Regulations</a>
              	<a href="{{ route('wizard.subjectCategories') }}" class="btn btn-info">Relevant Subject Categories</a>
