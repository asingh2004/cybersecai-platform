                            ...
                            <div class="col-md-12 p-4">
                                <form id='profile_update' method='post' action="{{url('users/profile')}}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mt-3">
                                                <label for="user_last_name">Surname<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mt-3">
                                                <label for="user_email"> Your Email (note it is also your log in)   
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="user_live">   Company/ Business Address 
                                                </label>
                                                <input class='form-control  text-16' type='text' name='details[live]' value="{{(isset($details['live']) && !empty($details['live'])) ? $details['live'] : '' }}" id='live' size='60'>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    // All code related to DOB removed

    // (No ageValidate or birthday fields JS needed)
