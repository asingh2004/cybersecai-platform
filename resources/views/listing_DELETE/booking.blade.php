							...
							<form id="booking_id" method="post" action="{{url('listing/'.$result->id.'/'.$step)}}"  accept-charset='UTF-8'>
								...
								<div class="col-md-12 p-0 mt-4 border rounded pb-4 m-0">
									<div class="form-group col-md-12 main-panelbg pb-3 pt-3 pl-4">
											<h4 class="text-16 font-weight-700">{{trans('messages.listing_sidebar.booking')}} <span id="listing_name" class="fa fa-info-circle secondary-text-color"
                                                    data-html="true" data-bs-toggle="tooltip" data-placement="top"
                                                    title="Review each request - Will give your team 5 elapsed days to assess request & then accept /decline the request; good for respite bookings. Guests book instantly - Booking will be confirmed instantly, without your team gettign chance to assess the respite need; good for enquiry or visit to your facility."></span></h4>
									</div>
