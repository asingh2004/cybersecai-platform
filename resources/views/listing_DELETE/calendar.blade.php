	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header p-4">
				...
				<button type="button" class="btn-close text-28 mt-m-15" data-bs-dismiss="modal" aria-label="Close">
				...
				<form method="post" action="hotel_date_package/" class='form-horizontal' id='dtpc_form'>
					...
					<div class="form-group">
						<div class="col-md-12 p-0 text-right">
							<button type="button" class="btn btn-outline-danger text-14 mt-4 pl-4 pr-4 mr-2" data-bs-dismiss="modal">{{trans('messages.listing_calendar.close')}}</button>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header p-4">
				...
				<button type="button" class="btn-close mt-m-15" data-bs-dismiss="modal" aria-label="Close">
				...
				<form id='icalendar_form'>
					...
					<div class="form-group">
						<div class="col-md-12 p-0 text-right mt-5">
							...
							<button type="button" class="btn btn-outline-danger text-16 cls-reload pl-4 pr-4 ml-2" data-bs-dismiss="modal">{{trans('messages.listing_calendar.close')}}</button>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header p-4">
				...
				<button type="button" class="btn-close mt-m-15 p-0" data-bs-dismiss="modal" aria-label="Close">
								...
								<div class="row justify-content-start mb-4">
									<ul class="list-inline ml-4">
										...
										<li class="list-inline-item mt-4">
											<!-- Button trigger modal -->
											<button type="button" class="text-white text-16 btn secondary-bg" data-bs-toggle="modal" data-bs-target="#hotel_date_package" > {{trans('messages.ical.manage_availability')}}</button>
										...
										<li class="list-inline-item mt-4">
											...
											<!-- Button trigger modal -->
											<button type="button" class="text-white text-16 btn secondary-bg" data-bs-toggle="modal" data-bs-target="#import_calendar_package" > {{trans('messages.ical.import_calendar')}}</button> 
										</li>

										<li class="list-inline-item mt-4">
											
											<!-- Button trigger modal -->
											<button type="button" class="text-white text-16 btn secondary-bg" data-bs-toggle="modal" data-bs-target="#calendar_export_package" > {{trans('messages.ical.export_calendar')}}</button> 
...
<script type="text/javascript">
	...
	$('#icalendar_form').validate({  
      ...
      $(function () {
        $("#dtpc_start").datepicker({ dateFormat: "dd/mm/yy", defaultDate: +1 });
        $("#dtpc_end").datepicker({ dateFormat: "dd/mm/yy", defaultDate: +2 });
      });
