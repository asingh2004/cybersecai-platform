							...
							<div class="col-md-12 border mt-4 pb-5 rounded-3 pl-sm-0 pr-sm-0 ">
								...
								<div class="row mt-4">
									<div class="col-md-12 pl-5 pr-5">
										<label>{{trans('messages.listing_description.listing_name')}} <span class="text-danger">*</span> <span id="listing_name" class="fa fa-info-circle secondary-text-color"
                                                    data-html="true" data-bs-toggle="tooltip" data-placement="top"
                                                    title="Give listing a meaningful name as it is visible to the seekers. For example, you may consider using name of the Nursing Home with suffix that describes it & creates an unique name for each listing, ie Grandeur Care Premium Room Facing Ocean"></span></label>
										<input type="text" name="name" id="name" class="form-control text-16 mt-2" value="{{ old('name', $description->properties->name)  }}" placeholder="" maxlength="300">
