                    ...
                    <div class="event-view-card mb-4">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <span class="event-status-badge {{ $stat === 'complete' ? 'complete' : 'inprogress' }} ms-3" title="Status">
                                <i class="fa fa-check-circle"></i> {{ ucfirst($event->status ?? 'In Progress') }}
                            </span>
                            <span class="badge badge-risk {{ $risk }} ms-2" title="Risk Level">
                                <i class="fa fa-exclamation-triangle"></i> {{ ucfirst($event->risk ?? 'Unscored') }}
                            </span>
                        </div>
                        ...
                        <a href="{{ route('gdpr.events.index') }}" class="back-link">
