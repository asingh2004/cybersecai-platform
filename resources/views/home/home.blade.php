...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
 ...
 <!-- AGENTIC EDGE SHOWCASE SECTION -->
<div class="w3-container w3-center" style="padding:36px 0 16px 0; max-width:740px; margin:0 auto;">
  <div style="font-size:1.45em;font-weight:800;color:#1877c2;margin-bottom:7px;">
    The cybersec<span style="color:#36d399;">ai.io</span> Edge
  </div>
  <div style="display:flex;flex-wrap:wrap;gap:18px;justify-content:center;margin:26px 0;">
    <div style="background:#e7fbea;flex:1;min-width:206px;max-width:232px;padding:18px 13px 13px 13px;border-radius:13px;box-shadow:0 3px 13px #36d39918;text-align:left;">
      <i class="fa fa-bolt" style="color:#36d399;font-size:1.3em;"></i>
      <div style="font-size:1.08em;font-weight:700;margin-bottom:7px;">Agentic AI</div>
      <div style="font-size:1em;">Autonomous bots that close the loop—<b>acting, explaining, remediating</b> without manual scripts.</div>
    </div>
    <div style="background:#e8f6fd;flex:1;min-width:206px;max-width:232px;padding:18px 13px 13px 13px;border-radius:13px;box-shadow:0 3px 13px #1877c218;text-align:left;">
      <i class="fa fa-clock" style="color:#1877c2;font-size:1.2em;"></i>
      <div style="font-size:1.08em;font-weight:700;margin-bottom:7px;">Real-Time</div>
      <div style="font-size:1em;">Instant results—<b>continuous</b> risk rating and audit evidence the moment your files change.</div>
    </div>
    <div style="background:#f1faff;flex:1;min-width:206px;max-width:232px;padding:18px 13px 13px 13px;border-radius:13px;box-shadow:0 3px 13px #b4e6fb18;text-align:left;">
      <i class="fa fa-file-alt" style="color:#36d399;font-size:1.2em;"></i>
      <div style="font-size:1.08em;font-weight:700;margin-bottom:7px;">Explainable</div>
      <div style="font-size:1em;">Admin and auditor-ready: <b>plain-language evidence</b> accompanies every AI finding and action.</div>
    </div>
  </div>
  <div style="margin-top:18px;">
    <a href="#ai-compliance-bot" class="btn btn-success" style="font-weight:700;font-size:1.08em;">Try These Capabilities Live &nbsp; <i class="fa fa-arrow-right"></i></a>
  </div>
</div>
...
<div class="w3-container w3-center" id="ai-compliance-bot" style="padding:68px 0 32px 0; max-width:600px; margin:0 auto;">
  ...
  <div class="w3-panel w3-pale-green w3-leftbar w3-border-green" style="margin-top:20px;text-align:left;">
    <div style="font-size:1.05em;color:#36d399;"><b>✓ Agentic AI: </b> Automated ticket/action opened for this file.</div>
    <div style="font-size:1.05em;color:#1877c2;"><b>✓ Real-Time:</b> Risk scored and result displayed <b>instantly</b>.</div>
    <div style="font-size:1.05em;"><b>✓ Explainable:</b> <span style="color:#1a8562;">{!! session('ai_scan_summary') !!}</span></div>
    <div style="margin-top:15px;">
      <a class="btn btn-warning" href="{{ route('demo.request.form') }}">See a Full Compliance Loop Demo</a>
    </div>
  </div>
@endif
...
<div class="w3-container w3-center w3-dark-grey" style="padding:96px 16px" id="pricing">
  ...
  <div class="pricing-table">
    <div class="pricing-plan">
      ...
      <div class="pricing-price">USD 10<span style="font-size:0.9em;">/user/mo</span></div>
    ...
    <li>
        ...
        Free On-Boarding support, includes upto 10k files. Charges apply beyond this.
    </li>
    <li>
        <span class="shield-bullet">
            <svg viewBox="0 0 28 28"><path d="M14 3c4.6 3.2 11 3.2 11 10.4C25 27.4 14 29 14 29S3 27.4 3 13.4C3 6.2 9.4 6.2 14 3z" fill="#36d399" stroke="#1877c2" stroke-width="1.5"/><polyline points="9,16 13,20 20,12" fill="none" stroke="#fff" stroke-width="2.2" stroke-linecap="round"/></svg>
    ...
    <div class="pricing-plan popular">
      ...
      <div class="pricing-price">USD 9<span style="font-size:0.9em;">/user/mo</span></div>
      <ul class="pricing-features">
    <li>
        <span class="shield-bullet">
            <svg viewBox="0 0 28 28"><path d="M14 3c4.6 3.2 11 3.2 11 10.4C25 27.4 14 29 14 29S3 27.4 3 13.4C3 6.2 9.4 6.2 14 3z" fill="#36d399" stroke="#1877c2" stroke-width="1.5"/><polyline points="9,16 13,20 20,12" fill="none" stroke="#fff" stroke-width="2.2" stroke-linecap="round"/></svg>
    ...
    <li>
        ...
        Once off charge for On-Boarding, includes upto 10k files. Charges apply beyond this.
    </li>
    <li>
        <span class="shield-bullet">
            <svg viewBox="0 0 28 28"><path d="M14 3c4.6 3.2 11 3.2 11 10.4C25 27.4 14 29 14 29S3 27.4 3 13.4C3 6.2 9.4 6.2 14 3z" fill="#36d399" stroke="#1877c2" stroke-width="1.5"/><polyline points="9,16 13,20 20,12" fill="none" stroke="#fff" stroke-width="2.2" stroke-linecap="round"/></svg>
