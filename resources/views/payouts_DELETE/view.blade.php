			...
			<div class="container-fluid min-height">
				<div class="main-panel">
					<div class="row justify-content-center mt-5">
							...
							<nav class="navbar navbar-expand-lg navbar-light list-bacground border rounded-3 p-3">
								...
								<ul class="nav nav-pills nav-fill">
									<li class="nav-item pl-4 pr-4">
										<a class="nav-link text-color text-color-hover" href="{{ url('users/payout-list') }}">{{trans('messages.sidenav.payouts')}}</a>
									</li>

									<li class="nav-item  pl-4 pr-4">
										<a class="nav-link text-color secondary-text-color font-weight-700  text-color-hover" href="{{ url('users/payout') }}">{{trans('messages.account_sidenav.account_preference')}}</a>
									</li>

                                    <li class="nav-item  pl-4 pr-4">
                                        <span class="text-color font-wight-700">
                                        	<a class="nav-link disabled">{{trans('messages.users_dashboard.my_wallet')}}: {!! moneyFormat( $currentCurrency->symbol, $walletBalance->total) !!}</a>
						...
						<div class="col-md-12">
							<button type="button" class="btn vbtn-outline-success text-14 font-weight-700 pl-4 pr-4 pt-3 pb-3 mt-4 float-right" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg">
								...
								<div class="wrapper border mb-5">
									...
									<div class="text-center pb-4 pt-4">
										<form action="{{ url('users/payout/delete-payout/'.$payout->id) }}" method="post" id="delete-payout-form">
											{{ csrf_field() }}
											@if($payout->type == 4)
											<a class="p-2 editmodal" data-bs-toggle="modal" data-id="{{ $payout->id }}"  data-bs-target=".edit-modal" data-obj="{{json_encode($payout->getAttributes())}}"><i class="fas fa-edit secondary-text-color"></i></a>
											@else
											<a class="p-2 editmodal2" data-bs-toggle="modal" data-id="{{ $payout->id }}"  data-bs-target=".edit-modal2" data-obj="{{json_encode($payout->getAttributes())}}"><i class="fas fa-edit secondary-text-color"></i></a>
											@endif
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<button type="button" class="btn-close text-28" data-bs-dismiss="modal" aria-label="Close">
			...
			<form action="{{url('users/payout/setting')}}" id="add_payout_setting" method="post" name="add_payout_setting" accept-charset='UTF-8'>
				...
				<div class="row p-4">
					...
					<div class="col-md-12 text-right mt-4">
						<button type="button" class="btn btn-outline-danger text-14 mt-2 pl-4 pr-4 mr-2 " data-bs-dismiss="modal">{{trans('messages.utility.close')}}</button>
		...
		<div class="modal-content">
			...
			<form action="{{url('users/payout/edit-payout')}}" id="edit_payout_setting" method="post" name="edit_payout_setting" accept-charset='UTF-8'>
				...
				<div class="modal-footer p-4">
					<button type="button" class="btn btn-outline-danger text-14" data-bs-dismiss="modal">{{trans('messages.utility.close')}}</button>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="{{url('users/payout/edit-payout')}}" id="edit_payout_setting2" method="post" name="edit_payout_setting2" accept-charset='UTF-8'>
				...
				<div class="modal-footer p-4">
					<button type="button" class="btn btn-outline-danger text-16" data-bs-dismiss="modal">{{trans('messages.utility.close')}}</button>
