    ...
    public function ajax()
    {
        ...
        ->addColumn('action', function ($withDrawal) {
            if ($withDrawal->status == 'Pending') {
                return '<a href="' . url('admin/payouts/edit/' . $withDrawal->id) . '" class="btn btn-xs btn-primary" title="Edit payout"><span class="glyphicon glyphicon-edit"></span>Edit</a>&nbsp;';
            }else{
                return '<a href="' . url('admin/payouts/details/' . $withDrawal->id) . '" class="btn btn-xs btn-primary" title="Details"><span class="glyphicon glyphicon-tasks"></span>Delete</a>&nbsp;';
