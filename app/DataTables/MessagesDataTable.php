    ...
    public function ajax()
    {
        return datatables()
            ...
            ->addColumn('action', function ($message) {
                $edit   = $delete = '';
                $edit   = \Helpers::has_permission(Auth::guard('admin')->user()->id, 'edit_messages') ?'<a href="'.url('admin/send-message-email/'.$message->id).'" class="btn btn-xs btn-primary"><span class="glyphicon glyphicon-edit">Edit</span></a>&nbsp;':'';
