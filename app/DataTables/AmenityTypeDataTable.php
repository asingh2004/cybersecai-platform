    ...
    public function ajax()
    {
        return datatables()
            ...
            ->addColumn('action', function ($amenityType) {
                ...
                $edit   = '<a href="' . url('admin/settings/edit-amenities-type/' . $amenityType->id) . '" class="btn btn-xs btn-primary"><span class="glyphicon glyphicon-edit"></span>Edit</a>&nbsp;';
                $delete = '<a href="' . url('admin/settings/delete-amenities-type/' . $amenityType->id) . '" class="btn btn-xs btn-danger delete-warning"><span class="glyphicon glyphicon-trash"></span>Delete</a>';
