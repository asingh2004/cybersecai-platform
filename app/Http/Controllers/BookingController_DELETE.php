...
class BookingController extends Controller
{
    ...
    */
    public function index(Request $request)
    {
        ...
        $is_discounted = Bookings::where('id','=',$request->id)->whereNotNull('discount_code')->first();
    ...
    */
    public function requestPayment(Request $request){
        ...
        $data['is_discounted'] = Bookings::where('id','=',$request->id)->whereNotNull('discount_code')->first();
    ...
    */
    public function accept(Request $request, EmailController $email)
    {
     ...
     if(!empty($request->message)) {
        ...
        $requestBookingConfirm = ($companyName.': ' .'Your booking request for'.' '.$booking->properties->name .' '.'has been Accepted. Please pay the booking fees.');
    ...
    */
    public function decline(Request $request, EmailController $email)
    {
        ...
        $email->bookingAcceptedOrDeclined($request->id, $status);
        $companyName = Settings::getAll()->where('type', 'general')->where('name', 'name')->first()->value;
        $requestBookingDecline = ($companyName.': ' .'Your booking request for'.' '.$booking->properties->name .' '.'has been Declined.');
    ...
    public function myBookings(Request $request)
    {
        ...
        switch ($request->status) {
            case 'Expired':
                ...
                // 5 days to accept or reject bookign request
                $params  = [['created_at', '<', $dt->subDays(7)], ['status', '!=', 'Accepted']];
            ...
            case 'Pending':
                ...
                // 5 days to accept or reject bookign request
                $params           = [['created_at', '>', $dt->subDays(7)], ['status', $request->status]];
                break;
            default:
                $params           = [];
                break;
