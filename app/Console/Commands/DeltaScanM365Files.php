...
{
    protected $signature = 'delta:m365files {--max-workers=8 : Max workers for multiprocessing}';
    protected $description = 'Delta Scan M365 OneDrive/SharePoint files via Python (multiprocessing-safe, resumable, writes compliance/secrets outputs)';
    ...
    public function handle()
    {
        ...
        foreach ($configs as $config) {
            ...
            Log::info("[DeltaM365] config_id=$config_id, regulations arg: $regulations");

            $subs_file = "/home/cybersecai/htdocs/www.cybersecai.io/webhook/subscriptions_bulk_{$config_id}.json";
            $script    = '/home/cybersecai/htdocs/www.cybersecai.io/webhook/M365/m365_delta_scan.py';
            ...
            Log::info("[DeltanM365] COMMAND for config $config_id: " . $cmd_shell);
            Log::info("[DeltaM365] CMD ARRAY for config $config_id: " . json_encode($cmd));
            ...
            Log::info("[DeltaM365] STDOUT (Config $config_id): " . $stdout);
            Log::info("[DeltaM365] STDERR (Config $config_id): " . $stderr);
            Log::info("[DeltaM365] Status (Config $config_id): $status");
        ...
        $summary = "M365 Files delta scan finished: $successes successes, $errors errors.";
        $this->info($summary);
        Log::info($summary);
